...
Apache Flink could save the world again?

- Just use [flink-cdc] and the [Flink Postgres CDC Connector]
...
- https://medium.com/@jatinpalsingh81/stream-changes-from-amazon-rds-for-postgresql-using-amazon-kinesis-data-streams-and-aws-lambda-392c557ba046
- https://www.commerce-architects.com/post/exploring-strategies-for-data-replication-from-rds-to-kinesis

More resources.

- https://github.com/psycopg/psycopg/issues/71
- https://github.com/MagicStack/asyncpg/issues/91
...
- That's a sweet introduction to `pg_replicate` by its author:
  ...
  > [pg_replicate]. pg_replicate lets you very easily build applications which can
